...
class QuizController {
  ...
  final List<Question> _questionBank = [
    ...
    Question('LAN adalah jaringan komputer dengan area yang berskala kecil.', true),
    ...
    Question('ALU adalah komponen dari CPU yang bertugas melakukan perhitungan aritmatika dan pembadingan.', true),
